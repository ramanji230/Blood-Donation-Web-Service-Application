...
<title>MyDiary Blood Donation homepage</title>
...
<div class="first">
<img src="<c:url value="/images/icon.jpg"/>" width="60" height="60">
</div>
<div class="second">Blood Donation App</div>
...
<div class="bodypart1">
<img src="<c:url value="/images/icon.jpg"/>" width="350px" height="350px">
</div>
